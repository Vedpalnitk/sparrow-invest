...
const VALUE_PROPS = [
  {
    ...
    desc: 'Monitor platform health and user activity',
    icon: (
  ...
  {
    title: 'User & Advisor Management',
    desc: 'Manage all accounts from one dashboard',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
  ...
  },
  {
    ...
    desc: 'Fine-tune AI recommendation engines',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
