...
import { useNotification } from '@/components/advisor/shared/FANotification';
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                <button
                  onClick={() => info('Recommendation feature coming soon')}
                ...
                <button
                  ...
                  style={{
                    background: isWatchlisted ? `${colors.primary}15` : colors.chipBg,
                    border: `1px solid ${isWatchlisted ? colors.primary : colors.chipBorder}`,
                ...
                <button
                  onClick={() => router.push(`/advisor/compare?fund=${schemeCode}`)}
                  className="w-full py-3 rounded-xl text-sm font-semibold transition-all flex items-center justify-center gap-2"
                  style={{
                    background: colors.chipBg,
                    border: `1px solid ${colors.chipBorder}`,
